...
use biome_console::{HorizontalLine, Markup, MarkupBuf, MarkupElement, MarkupNode, fmt, markup};
...
pub use self::{
    backtrace::{Backtrace, set_bottom_frame},
    message::MessageAndDescription,
};
use crate::{
    Advices, Diagnostic, DiagnosticTags, Location, LogCategory, Resource, Severity, Visit,
    diagnostic::internal::AsDiagnostic, display::frame::SourceFile,
};
...
mod tests {
    ...
    use crate::{
        self as biome_diagnostics, Advices, Diagnostic, Location, LogCategory, PrintDiagnostic,
        Resource, SourceCode, Visit,
    };
